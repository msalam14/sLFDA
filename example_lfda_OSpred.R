...
lfda_ospred<-OutSamPWPRED(lfdaOBJ=lfda_fit,TimeOBJ=do.call(c,Tij),
             nfunDATA=ngdata$Y,nfunARG=NULL,nobsTIME=nTij,
                       identical.ARG=TRUE,gridS=NULL,gridT=lapply(nTij,function(u){max(u)+0.2}))

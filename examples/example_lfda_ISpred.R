...
# In-sample prediction using the fitted lfda object

pred_lfda<-PWPRED(lfdaOBJ=lfda_fit,TimeOBJ=do.call(c,Tij),gridS=NULL,gTID=c(6,10,23),gridT=list(c(0.60,0.80),c(0.82,0.90),c(0.88,0.95)))

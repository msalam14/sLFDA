...
![“P-values associated with pointwise asymmetry test for DTI data with
equal and unequal-sized bins. Asterisks indicate of significant
skewness. A type-I error rate of $5\%$ is ensured by the Bonferroni
correction for multiple
testing.”](DTI_RESULTS/pval_heatmap_refund_dti.png)
